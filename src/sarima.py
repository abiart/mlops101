...
class SklearnSarima(BaseEstimator):
    ...
    def __init__(self, x_series, param: tuple = None, param_seasonal: tuple = None):
    ...
    def fit_best_params(self, y_series, search_params=list) -> None:
        ...
        for param in tqdm(search_params, desc="Finding best parameters"):
            ...
            try:
                ...
                mape_result = mean_absolute_percentage_error(
                    y_series, predictions.predicted_mean
                )
        ...
        # Fit a model with the best params
        self.set_params({"pdq": best_params["pdq"], "spdq": best_params["spdq"]})
    ...
    def get_params(self) -> dict:
        ...
        return {"pdq": self.param_pdq, "spdq": self.param_spdq}
