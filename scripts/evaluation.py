...
for prod_cat in prod_categories:
    xgb_exp1 = pd.read_csv(
        proj_path / catalog["results"]["dir"] / f"xgb_exp1_{prod_cat}.csv"
    )
...
for prod_cat in prod_categories:
    ...
    results = pd.DataFrame(
        [metrics_sarima, metrics_prophet, metrics_xgb],
